	...
	return (
		<div className="delete-profile">
			...
			<div className="delete-profile__warning">
				Ты удаляешь свою учётную запись в Remember to progress. Это
				также удалит всю информацию, которая с ней связана. Пожалуйста,
			...
			<form onSubmit={(e) => deleteProfileSubmit(e)}>
				<label
					className="delete-profile__password-label"
					htmlFor="password"
				>
					пароль
				</label>
