  ...
  return (
    ...
    >
      <div className="task-details__button-wrapper">
        <button className="task-details__close-button" onClick={hideDetails}>
          &#8592; {todoListName}
        </button>
        <button ref={closeTodoDetailsButton} onClick={buttonClickHandler}>
          закрыть &nbsp;х
        </button>
      </div>
        ...
        <div className="edit-fields">
          ...
          {todoDetails.todo.begin_at ? (
            <div className="date">
              ...
              <div className={"value"}>
                {moment(todoDetails.todo.begin_at).format("dd, DD MMM YY")}
              </div>
            </div>
          ) : null}
          {/* will_end_at */}
          {todoDetails.todo.will_end_at ? (
            <div className="date">
              ...
              <div className={"value"}>
                {moment(todoDetails.todo.will_end_at).format("dd, DD MMM YY")}
              </div>
            </div>
          ) : (
            <div className="date">
